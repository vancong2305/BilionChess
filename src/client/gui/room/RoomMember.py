...
class RoomMember:
    def __init__(self, room_name, player_name):
        ...
        pygame.display.set_caption("Giao diện Room Member")
        ...
        self.buttons = [
            ...
            Button(self.button_x, 300 + (self.button_height + self.button_spacing) * 2, self.button_width, self.button_height, "Rời phòng", self.leave_room)
        ]
